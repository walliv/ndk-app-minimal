...
if {$ARCHGRP_ARR(APP_CORE_ENABLE)} {
    ...
    lappend MOD "$RISCV_SRCS_ROOT/OR_pair_reducer_sl.vhd"
    lappend MOD "$RISCV_SRCS_ROOT/OR_pair_reducer.vhd"
    lappend MOD "$RISCV_SRCS_ROOT/generic_successive_row_or_reducer.vhd"

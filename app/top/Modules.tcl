...
if {$ARCHGRP_ARR(APP_CORE_ENABLE)} {
    ...
    lappend MOD "$RISCV_SRCS_ROOT/generic_or.vhd"
    lappend MOD "$RISCV_SRCS_ROOT/generic_row_or_reducer.vhd"
    lappend MOD "$RISCV_SRCS_ROOT/generic_iterative_row_or_reducer.vhd"

...
proc do_adjust_rtile_pcie_ip_2x8 {} {
    ...
    set_instance_parameter_value intel_rtile_pcie_ast_0 {core8_pf0_pci_type0_device_id_hwtcl} {49152}
...
proc do_adjust_rtile_pcie_ip {device family ipname filename adjust_proc} {
    ...
    set_instance_parameter_value intel_rtile_pcie_ast_0 {core16_pf0_pci_type0_device_id_hwtcl} {49152}
